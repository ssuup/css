(function($){    
  $.fn.extend({
    slideFocusPlugin:function(options){
      ...
      _this.tabTagArr.on(_this.options.funType,function(){
      ...
      if(_this.options.funType == "mouseover" || _this.options.funType == "mouseenter"){
        _this.tabTagArr.on("mouseout",function(){
          _this.hasNextPlay = false;
          clearTimeout(_this.delayTimeId);
        })
      }
      ...
      if(_this.options.arrowBtn){
        _this.find("."+_this.options.leftArrowBtnClass).on("click",function(){_prev();});
        _this.find("."+_this.options.rightArrowBtnClass).on("click",function(){_next();});
        if(!_this.options.btnShow){
          _this.on("mouseout",function(){
            _this.find("."+_this.options.leftArrowBtnClass).hide();
            _this.find("."+_this.options.rightArrowBtnClass).hide();
          })
          _this.on("mouseover",function(){
            _this.find("."+_this.options.leftArrowBtnClass).show();
            _this.find("."+_this.options.rightArrowBtnClass).show();
          })
        }
      }
      _this.tabTagArr.eq(_this.nextNum).addClass(_this.options.selectClass);
